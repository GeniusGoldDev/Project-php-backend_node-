...
$ch = curl_init('http://localhost:3000/users/roles' .$id); // Ensure this is the correct endpoint
...
if (isset($permissions['error'])) {
    die('Error fetching permissions: ' . htmlspecialchars($roles['error']));
}
// Debug output to inspect the structure of $permissions
$role_name = isset($roles[0][0]['role_name']) ? $roles[0][0]['role_name'] : 'Empty Role';

$role_count = count($roles[0]);
...
<base href="../../" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
				...
				<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize" data-kt-sticky-offset="{default: '200px', lg: '0'}" data-kt-sticky-animation="false">
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center d-lg-none ms-n3 me-1 me-md-2" title="Show sidebar menu">
							...
							<input id="role_ids" type="hidden" value="<?php echo($roles[0][0]['role_id']);?>" />
																...
																<div class="row">
																	...
																	<div class="col-lg-4 mb-6 mb-lg-0">
																		...
																		<div class="mb-0">
																			...
																			<div class="menu-item p-0 m-0">
																				<!--begin:Menu link-->
																				<a href="user-management/users/view.php" class="menu-link">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active" href="user-management/roles/view.php?id=1">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="login.php" class="menu-link px-5">Sign Out</a>
										</div>
										<!--end::Menu item-->
									</div>
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_66b9704e702b0">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_66b9704e702b0" data-allow-clear="true">
																<option></option>
										...
										<div class="flex-column flex-lg-row-auto w-100 w-lg-200px w-xl-300px mb-10">
											...
											<div class="card card-flush">
												...
												<div class="card-body pt-0">
													...
													<!--end::Permissions-->
													<button id="<?php echo htmlspecialchars($role['id']); ?>" type="button" class="edit_role_button btn btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_role">Edit Role</button>
												</div>
												<!--end::Card body-->
												<!--begin::Card footer-->
												<!--end::Card footer-->
															...
															<form id="kt_modal_update_role_form" class="form" action="#">
																...
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_role_header" data-kt-scroll-wrappers="#kt_modal_update_role_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="fv-row mb-10">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input class="form-control form-control-solid" placeholder="Enter a role name" name="role_name" value="<?php echo htmlspecialchars($role_name); ?>" />
																		<!--end::Input-->
																		</div>
																	<!--end::Input group-->
																	<!--begin::Permissions-->
																	<div class="fv-row">
																		...
																		<div class="table-responsive">
																			<!--begin::Table-->
																			<table id="form" class="table align-middle table-row-dashed fs-6 gy-5">
																				<!--begin::Table body-->
																				<tbody class="text-gray-600 fw-semibold">
																					<!--begin::Table row-->
                                                                                    <?php foreach($roles[2] as $role): ?>
																					<tr>
																						<!--begin::Label-->
																						<td class="text-gray-800"><?php echo htmlspecialchars($role['menu_name']); ?></td>
																						<!--end::Label-->
																						<!--begin::Input group-->
																						<td>
																							<!--begin::Wrapper-->
																							<div class="d-flex">
																								...
																								<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
																									<input class="form-check-input" type="checkbox" value="view_users" name="permissions[<?php echo $role['menu_name']; ?>][]" />
																									<span class="form-check-label">Read</span>
																								</label>
																								<!--end::Checkbox-->
																								<!--begin::Checkbox-->
																								<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
																									<input class="form-check-input" type="checkbox" value="update_users" name="permissions[<?php echo $role['menu_name']; ?>][]" />
																									<span class="form-check-label">write</span>
																								</label>
																								<!--end::Checkbox-->
																								<!--begin::Checkbox-->
																								<label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
																									<input class="form-check-input" type="checkbox" value="create_users" name="permissions[<?php echo $role['menu_name']; ?>][]" />
																...
																<div class="text-center pt-15">
																	...
																	<button id="role_edit" type="submit" class="btn btn-primary" data-kt-roles-modal-action="submit">
                                            ...
                                            <div class="card card-flush mb-6 mb-xl-9">
												...
												<div class="card-header pt-5">
													...
													<div class="card-title">
														...
														<span class="text-gray-600 fs-6 ms-1">(<?php echo($role_count);?>)</span></h2>
													</div>
													<!--end::Card title-->
													<!--begin::Card toolbar-->
													<div class="card-toolbar">
															...
															<tr>
																...
																<td class="d-flex align-items-center">
																	...
																	<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																		<div class="symbol-label">
																			<img src="http://localhost:3000/uploads/<?php echo($role['avatar']);?>" alt="John Miller" class="w-100" />
																		</div>
																	</div>
																	<!--end::Avatar-->
																	<!--begin::User details-->
																	<div class="d-flex flex-column">
																		<p class="text-gray-800 text-hover-primary mb-1"><?php echo htmlspecialchars($role['username']); ?></p>
																		<span><?php echo htmlspecialchars($role['email']); ?></span>
																	</div>
																	<!--begin::User details-->
																</td>
																...
																<td class="text-end">
																	...
																	<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																		...
																		<!--begin::Menu item-->
																		<div class="menu-item px-3">
																			<a href="#" class="menu-link px-3 deleteRoleButton" data-user-id="<?php echo htmlspecialchars($role['id']); ?>" data-kt-roles-table-filter="delete_row">Delete</a>
																		</div>
																		<!--end::Menu item-->
																	</div>
																	<!--end::Menu-->
        ...
        <script>
			...
			document.getElementById('role_edit').addEventListener('click', function(event) {
				event.preventDefault(); // Prevent form submission for now
				const form = document.getElementById('kt_modal_update_role_form');
				const formData = new FormData(form);
				const role_id = document.getElementById('role_ids').value;
				let permissions = {};

				formData.forEach((value, key) => {
					if (key.startsWith('permissions')) {
						const menuName = key.match(/\[(.*?)\]/)[1]; // Extract menu_name
						if (!permissions[menuName]) {
							permissions[menuName] = [];
						}
						permissions[menuName].push(value); // Collect permissions (read, write, create)
					}
				});
				fetch(`http://localhost:3000/users/roles/${role_id}`, {
                    method: 'PUT', // Use 'PATCH' if you want to update only specific fields
                    headers: {
						'Content-Type': 'application/json', // Tell the server you're sending JSON
					},
					body: JSON.stringify({ permissions }), // Convert the data to JSON
                });

				console.log(role_id);
				console.log(permissions);
				// You can now send this 'permissions' object to the server using AJAX or process as needed
			});
        </script>
	</body>
	<!--end::Body-->
