...
$id = $_GET['id'];
$ch = curl_init('http://localhost:3000/users/setting/' .$id); // Ensure this is the correct endpoint
...
if (isset($users['error'])) {
    die('Error fetching users: ' . htmlspecialchars($users['error']));
}
...
<base href="../../" />
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
				...
				<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize" data-kt-sticky-offset="{default: '200px', lg: '0'}" data-kt-sticky-animation="false">
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            ...
                            <input type="hidden" id="id" value="<?php echo($users['id']);?>">
						</div>
						<!--end::Mobile logo-->
																...
																<div class="row">
																	...
																	<div class="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div class="mb-0">
																			...
																			<div class="menu-item p-0 m-0">
																				<!--begin:Menu link-->
																				<a href="pages/pricing/packages.php" class="menu-link">
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a id="logout" href="login.php" class="menu-link px-5">Sign Out</a>
										</div>
										<!--end::Menu item-->
									</div>
								...
								<div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<div data-kt-menu-trigger="click" class="menu-item here menu-accordion hover show">
												...
												<!--end:Menu link-->
												<!--begin:Menu sub-->
												<div class="menu-sub menu-sub-accordion show" kt-hidden-height="128" style="">
													<!--begin:Menu item-->
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
														...
														<!--end:Menu link-->
														<!--begin:Menu sub-->
														<div class="menu-sub menu-sub-accordion" kt-hidden-height="83" style="display: none; overflow: hidden;">
															<!--begin:Menu item-->
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link" href="user-management/users/list.php">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Users List</span>
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_66b970593426f">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_66b970593426f" data-allow-clear="true">
																<option></option>
											...
											<div class="d-flex flex-wrap flex-sm-nowrap">
												...
												<div class="me-7 mb-4">
													<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
														<img src="http://localhost:3000/uploads/<?php echo($users['avatar']);?>" alt="image" />
													...
													<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
														...
														<div class="d-flex flex-column">
															...
															<div class="d-flex align-items-center mb-2">
																<a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1"><?php echo($users['username']);?></a>
																<a href="#">
															...
															<div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
																<a href="user-management/roles/view.php?id=<?php echo($users['role_id']);?>" class="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
																<i class="ki-duotone ki-profile-circle fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																	<span class="path3"></span>
																</i><?php echo($users['role_name']);?></a>
																<a href="#" class="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
																<i class="ki-duotone ki-geolocation fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																</i><?php echo($users['time_zone']);?></a>
																<a href="#" class="d-flex align-items-center text-gray-500 text-hover-primary mb-2">
																<i class="ki-duotone ki-sms fs-4">
																	<span class="path1"></span>
																	<span class="path2"></span>
																</i><?php echo($users['email']);?></a>
															</div>
															<!--end::Info-->
														</div>
														<!--end::User-->
												...
												<div class="card-body border-top p-9">
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8">
															...
															<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
																...
																<div class="image-input-wrapper w-125px h-125px" style="background-image: url(http://localhost:3000/uploads/<?php echo($users['avatar']);?>)"></div>
														...
														<div class="col-lg-8">
															...
															<div class="row">
																...
																<div class="col-lg-12 fv-row">
																	<input id ="username" type="text" name="fname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="<?php echo($users['username']);?>" />
																</div>
																<!--end::Col-->
															</div>
															<!--end::Row-->
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<input id="company" type="text" name="company" class="form-control form-control-lg form-control-solid" placeholder="Company name" value="<?php echo($users['company']);?>" />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<input id="contact_phone" type="tel" name="phone" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="<?php echo($users['contact_phone']);?>" />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<input id="company_site" type="text" name="website" class="form-control form-control-lg form-control-solid" placeholder="Company website" value="<?php echo($users['company_site']);?>" />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<select id="country" name="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." class="form-select form-select-solid form-select-lg fw-semibold">
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<!--begin::Input-->
															<select id="language" name="language" aria-label="Select a Language" data-control="select2" data-placeholder="Select a language..." class="form-select form-select-solid form-select-lg">
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<select id="time_zone" name="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select a timezone.." class="form-select form-select-solid form-select-lg">
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<select id="currency" name="currnecy" aria-label="Select a Currency" data-control="select2" data-placeholder="Select a currency.." class="form-select form-select-solid form-select-lg">
														...
														<div class="col-lg-8 fv-row">
															...
															<div class="d-flex align-items-center mt-3">
																...
																<label class="form-check form-check-custom form-check-inline form-check-solid me-5">
																	<input id="communication" class="form-check-input" name="communication[]" type="checkbox" value="1" />
													...
													<div class="row mb-0">
														...
														<div class="col-lg-8 d-flex align-items-center">
															<div class="form-check form-check-solid form-switch form-check-custom fv-row">
																<input id="allow" class="form-check-input w-45px h-30px" type="checkbox" id="allowmarketing" checked="checked" />
        ...
        document.getElementById('kt_account_profile_details_submit').addEventListener('click', function() {
            ...
            const avatar = avatarInput.files.length > 0 ? avatarInput.files[0] : null;
            const communication_val = document.getElementById('communication');
            const communication = communication_val.value.length > 0 ? communication_val.value : null;
            const allow_val = document.getElementById('communication');
            const allow = allow_val.value.length > 0 ? allow_val.value : null;
            ...
            fetch(`http://localhost:3000/users/settingup/${id}`, {
