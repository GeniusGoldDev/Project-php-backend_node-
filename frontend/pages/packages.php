        ...
        <script>
            ...
            document.getElementById('packageForm').addEventListener('submit', function(event) {
                ...
                async function createPackage() {
                        try {
                            const response = await fetch('http://localhost:3000/users/create_package', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
                                body: JSON.stringify({ packageName,description,pricingPlan,price,packageStatus,featuresDetails }), // Correctly sending the new_role_name
                            });
